...
namespace Viguar.RuntimeTooling.Controllers.Singleplayer.FPSBase
{
    public class FirstPersonController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (crosshair && crosshairImage != null)
            {
    ...
    public class FirstPersonControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Viguar Industries", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Normal, fontSize = 12 });
            GUILayout.Label("Workshop Series 1", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter, fontStyle = FontStyle.Normal, fontSize = 12 });
            EditorGUILayout.Space();
